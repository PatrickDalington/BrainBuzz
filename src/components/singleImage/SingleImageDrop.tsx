...
const SingleImageDrop = React.forwardRef<HTMLInputElement, InputProps>(
  (
        ...
        >
          ...
          {imageUrl ? (
            ...
            <div className="flex flex-col items-center justify-center text-xs text-gray-400">
              ...
              <div className="text-gray-400">Upload blog header image</div>
              <div className="mt-3">
...
SingleImageDrop.displayName = 'SingleImageDropzone';
